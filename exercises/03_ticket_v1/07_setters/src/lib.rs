...
impl Ticket {
    fn is_validate_title (title: &String) {
        if title.is_empty() {
    ...
    fn is_validate_description (description: &String) {
    ...
    fn is_validate_status (status: &String) {
    ...
    pub fn new(title: String, description: String, status: String) -> Ticket {
        Ticket::is_validate_title(&title);
        Ticket::is_validate_description(&description);
        Ticket::is_validate_status(&status);
